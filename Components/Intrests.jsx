export default function Intrests() {
        ...
        <div className="intrests">
            ...
            <ul>
                ...
                <li>🌍 <strong>Apprentissage et Partage :</strong> Participer à des compétitions CTF et collaborer avec d`autres passionnés.</li>
                <li>🎨 <strong>Design :</strong> Concevoir des interfaces utilisateur intuitives et esthétiques avec Figma et Photoshop.</li>
            </ul>
            </p>
        </div>
    )
